<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuBook.aspx.cs" Inherits="Webz.WebIE.SuBook" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
      * { font-size: 36px; margin:0px; padding:0px;}
        ...
        .nianjilist {width:25%; height:350px; float:left; padding:4% 4% 0% 4%; border-bottom:solid 1px #EBEBEB;}
...
<body>
    ...
    <div>
        <img id="yuandian" src="Images/Imgs/圆点.png" />
            <div id="Pr_title">请选择学习科目</div>
            <div id="Pr_count">
               <asp:Repeater ID="RpList" runat="server">
                    <ItemTemplate>
                        <a href="BooksList.aspx?Prid=<%=Prid %>&Grid=<%=Grid %>&Suid=<%#Eval("suid") %>">
                        <div class="nianjilist">
                            <img src="Images/Imgs/<%#Eval("suName") %>图标.png"  width="100%"; height="70%" />
                            <span><%#Eval("suName") %></span>
                        </div>
                            </a>
                    </ItemTemplate>
                </asp:Repeater>
