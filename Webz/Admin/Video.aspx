...
<body runat="server">
    ...
    <div>
        <div style="min-height: 600px;">
            <div style="font-size: 12px;margin-left:12px">当前位置：视频匹配>模糊匹配</div>
            <div id="Div_pipei" style="background-color: #5DA4F9; height: 30px; line-height: 30px; width: 101.2%; position: relative; left: 1%;">
    ...
    <script>
        ...
        function AllBinding() {
            ...
            $(".But_quanxuanBD").click(function () {
                ...
                //alert($(AllckInput[0]).attr("BDTestId"));
