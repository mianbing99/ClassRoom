...
namespace Webz.WebIE
{
    public partial class Books : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int abc = 0; abc < CaList.Count; abc++)
            {  //移除所有子级目录
                            ...
                            foreach (Model.Catalog Cac in ErList)
                            {
                                if (Cab.CaID == Cac.TID)
                                {
                                    if (Cac.State == "0")
                                    {
                                        ...
                                        {
                                            str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Cac.Viid + "&caid=" + Cac.CaID + "&state=" + Cac.State + "\"><p class=\"kewen_z\" id=\"" + Cac.Viid + "\"><span class=\"span_name_z\">" + Cac.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/免费.png\" /></p></a>";
                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Cac.Viid + "&state=" + Cac.State + "\"><p class=\"kewen_z\" id=\"" + Cac.Viid + "\"><span class=\"span_name_z\">" + Cac.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/vip图标.png\" /></p></a>";
                                        }
                    ...
                    if (jj == 0)
                    {
                        if (Ca.CaNum == "" || Ca.CaNum == null)
                        {
                            if (Ca.State == "0")
                            {
                                ...
                                {
                                    str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Ca.Viid + "&state=" + Ca.State + "\"><p class=\"kewen\" id=\"" + Ca.Viid + "\"><span class=\"span_name\">" + Ca.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/免费.png\" /></p></a>";
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Ca.Viid + "&state=" + Ca.State + "\"><p class=\"kewen\" id=\"" + Ca.Viid + "\"><span class=\"span_name\">" + Ca.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/vip图标.png\" /></p></a>";
                                }
                            }
                        }
                        else
                        {
                            if (Ca.State == "0")
                            {
                                ...
                                {
                                    str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Ca.Viid + "&state=" + Ca.State + "\"><p class=\"kewen\" id=\"" + Ca.Viid + "\"><span class=\"span_num\">" + Ca.CaNum + "</span><span class=\"span_name\">" + Ca.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/免费.png\" /></p></a>";
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    str += "<a name=\"lianjie\" href=\"Video.aspx?viid=" + Ca.Viid + "&state=" + Ca.State + "\"><p class=\"kewen\" id=\"" + Ca.Viid + "\"><span class=\"span_num\">" + Ca.CaNum + "</span><span class=\"span_name\">" + Ca.CaName + "</span><img class=\"Vip\" src=\"Images/Imgs/vip图标.png\" /></p></a>";
                                }
