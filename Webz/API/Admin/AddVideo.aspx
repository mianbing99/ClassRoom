...
<body>
    <form id="form1" class="layui-form" action="" method="post" runat="server">
        ...
        <div style="font-size: 12px; margin-left:1%;">视频匹配>新增视频</div>
        ...
        <div style="height:510px; background:#ffffff;width:96%; border: solid 1px #aef2f5; margin-left:1%; ">
            <table>
                ...
                <tr>
                    ...
                    <td class="btncancel">
                        <button type="btnCancel" class="layui-btn layui-btn-primary" style="color: white;padding:0px 18px;">取消</button></td>
                    <td style="height:350px;"></td>
                </tr>
            </table>
        </div>
