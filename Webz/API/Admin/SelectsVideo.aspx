    ...
    <form id="form1" runat="server">
        <div>
            <div style="min-height: 600px;">
                    <div>
                        <div style="font-size: 12px;">视频匹配>批量匹配</div>
                        <div id="Div_pipei" style="background-color: #5DA4F9; height: 30px; line-height: 30px; width: 100%; position: relative; ">
                            <%-- //年级--%>
                        ...
                        <div style="margin-top: 0%;">
                            ...
                            <span style="margin-left: 37%;" class="layui-form">
                                <span class="chespan">
                            ...
                            <input type="button" class="But_quanxuan layui-btn layui-btn-sm" id="bangding" value="批量绑定" onclick="" V_M="0" />

                            <input type="button" class="But_quanxuan layui-btn layui-btn-sm" id="jiebang" value="批量解绑" V_M="1" />
                        </div>
                    </div>
                ...
                <script>
                    ...
                    $(function () {
                          ...
                          , count: count, //数据总数，从服务端得到
                            ...
                            for (var i = 0; i < data.list.length; i++) {
                                ...
                                $("#huadong table").append("<tr><td>" + data.list[i].num + "</td>" +
                                    ...
                                    "<td><input class='layui-btn layui-btn-sm But_Video' type='button' name='' id='' Pmp4='" + data.list[i].匹配 + "' Wmp4= '" + data.list[i].未匹配 + "'  value='预览'  /></td>" +
                                    "<td>" +
                                    "<input type='hidden' name='chekname' value='0' />" +
                                    "<span class='chek'></span>" +
                                    "<input type='hidden' value='' />" +
                                    "<input type='checkbox' lay-filter='BDing' class='chek' name='chek' id='' value='' V_XId=" + data.list[i].TempID + " />" +
                            ...
                            $(".But_Video").click(function () {
                                ...
                                if (Pmp4 != '') {
                                    ...
                                    if (Dis == "none") {
                                        ...
                                        $("#Video").attr("src", "http://183.60.136.8:188/" + Wmp4);
                        ...
                        $(".But_quanxuan").click(function () {
                          var Moshi=  $(this).attr("V_M");
                          var PPd = $("input[name='chek']:checked");
                          if (PPd.length > 0) {
                                var arr = "";
                                for (var i = 0; i < PPd.length; i++) {
                                    if (i + 1 == PPd.length) {
                                        arr += $(PPd[i]).attr("V_XId");
                                    } else {
                                        arr += $(PPd[i]).attr("V_XId") + ",";
                                    }
                                }
                                ...
                                layer.open({
                                    ...
                                    fixed: true, //不固定
                                    maxmin: false,
                                    content: 'BDing.aspx?DBMoshi=' + Moshi + '&Arr=' + arr
                                ...
                                if (Moshi==0) {
                                    layer.tips('请选择要绑定的数据', '#bangding', {
                                        tips: 3
                                    });
                                } else {
                                    layer.tips('请选择要解绑解数据', '#jiebang', {
                                        tips: 3
                                    });
                                }
