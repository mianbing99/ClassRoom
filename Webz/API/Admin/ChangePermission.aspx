...
<body>
    ...
    <div>
        <div class="ss" style="font-size: 12px;font-weight:bolder;">账号管理 > 更改账号权限</div>
        <div class="cent">
        ...
        <div class="table-b">
            ...
            <table width="950" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh1"></span><input type="radio" id="Radio1" name="chetiaojian" runat="server"  checked="checked" />新增</td>
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh2"></span><input type="radio" id="Radio2" name="chetiaojian" runat="server"  checked="checked" />导入</td>
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh3"></span><input type="radio" id="Radio3" name="chetiaojian" runat="server"  checked="checked" />导出</td>
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh4"></span><input type="radio" id="Radio4" name="chetiaojian" runat="server"  checked="checked" />修改</td>
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh5"></span><input type="radio" id="Radio5" name="chetiaojian" runat="server"  checked="checked" />删除</td>
                    <td width="122"><input type="hidden" name="chekname" value="0" /><span id="txyiwh6"></span><input type="radio" id="Radio6" name="chetiaojian" runat="server"  checked="checked" />查看</td>
                </tr>
                <tr>
        ...
        <asp:Button ID="btnShow" runat="server" Text="新增" OnClick="btnShow_Click" />
    </div>
    </form>
</body>
</html>
